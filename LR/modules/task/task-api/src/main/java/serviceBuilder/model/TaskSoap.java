...
/**
 * This class is used by SOAP remote services, specifically {@link serviceBuilder.service.http.TaskServiceSoap}.
 *
 * @author Brian Wing Shun Chan
 * @see serviceBuilder.service.http.TaskServiceSoap
 * @generated
 */
@ProviderType
public class TaskSoap implements Serializable {
	public static TaskSoap toSoapModel(Task model) {
		...
		soapModel.setFinished(model.isFinished());
