...
public class TaskLocalServiceWrapper implements TaskLocalService,
	...
	*/
	@Override
	public serviceBuilder.model.Task addTask(serviceBuilder.model.Task task) {
	...
	*/
	@Override
	public serviceBuilder.model.Task createTask(long taskId) {
	...
	*/
	@Override
	public serviceBuilder.model.Task deleteTask(long taskId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	*/
	@Override
	public serviceBuilder.model.Task deleteTask(serviceBuilder.model.Task task) {
	...
	*/
	...
	@Override
	public serviceBuilder.model.Task editTask(long taskId, String name,
		...
		return _taskLocalService.editTask(taskId, name, description,
			createDate, finishDate, finished, modifiedDate, userId, groupId,
			companyId);
	}

	@Override
	public serviceBuilder.model.Task fetchTask(long taskId) {
	...
	*/
	@Override
	public serviceBuilder.model.Task fetchTaskByUuidAndGroupId(String uuid,
		long groupId) {
	...
	*/
	@Override
	public serviceBuilder.model.Task getTask(long taskId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	*/
	@Override
	public serviceBuilder.model.Task getTaskByUuidAndGroupId(String uuid,
		long groupId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	public int getTaskCount(long userId) {
		return _taskLocalService.getTaskCount(userId);
	}
	...
	*/
	@Override
	public java.util.List<serviceBuilder.model.Task> getTasks(int start, int end) {
		return _taskLocalService.getTasks(start, end);
	}

	@Override
	public java.util.List<serviceBuilder.model.Task> getTasks(long userId) {
	...
	*/
	@Override
	public java.util.List<serviceBuilder.model.Task> getTasksByUuidAndCompanyId(
	...
	*/
	@Override
	public serviceBuilder.model.Task updateTask(serviceBuilder.model.Task task) {
