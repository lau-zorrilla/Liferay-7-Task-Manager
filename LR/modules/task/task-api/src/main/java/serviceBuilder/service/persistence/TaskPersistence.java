...
public interface TaskPersistence extends BasePersistence<Task> {
	...
	* @return the matching tasks
	*/
	public java.util.List<Task> findByByUserId(long userId);
	...
	* @return the range of matching tasks
	*/
	public java.util.List<Task> findByByUserId(long userId, int start, int end);
	...
	* @return the matching tasks
	*/
	public java.util.List<Task> findByByUserIdAndFinished(long userId,
		boolean finished);
